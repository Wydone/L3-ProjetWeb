...
<body>
    <div class="bandeau">
        <h1>Festival Théâtres de Bourdon : tarifs</h1>
    </div>
    ...
    <main>
        <div class="decalage">
            <section class="section-block">
                ...
                <p>
                	La représentation du 6 août au CNCS de Moulins étant avancée à 20h00 (par rapport à l'information transmise sur votre flyer), la vente aura lieu du 2 au 5 août dans les villages susnommés et sur place dès 19h00 le 6 août 2019.  
                </p>

                <p> 
                    Sont acceptés les paiements en espèces, les chèques sur présentation d'une pièce d'identité au même nom et dans la mesure du fonctionnement du réseau cellulaire et d'une surtaxe de 1 euro par transaction les paiements par carte bancaire. En cas d'achat groupé un billet est offert dès 5 billets payés. 
                </p>
                ...
                <h2> S: invitation Spéciale pour les membres bienfaiteurs du festival
                <h2> E: Enfant gratuit (-12 ans)  </h2>
            ...
            <section class="section-block"><!-- Explication des tarifs -->
                ...
                <section><!-- Présentation de l'association -->
                    <h1 id="label_Contexte"> Notre contexte tarifaire </h1>
                        ...
                        <h2> 	Théâtres de Bourbon est une association à but non lucratif </h2>
                            <p>	<img class="vignette" src="images/logo.png" alt="[logo de l'association]" width=20% height=20% decoding=low >		
                ...
                <section><!--Financeurs-->
                    ...
                    <p> Communauté de commune de Saint Pourcain la Sioule
                        <div> 
                            <a href="http://www.comcompayssaintpourcinois.fr" target="_blank" rel="noopener noreferrer">
                                <img  
                                    src="images/imgSponsorLogoCommunauteCommune.jpg"
                                    alt="[ LogoCommunautéDeCommune]"
                                    width=50%
                                    height=50%
                                    decoding=low
                                > 
