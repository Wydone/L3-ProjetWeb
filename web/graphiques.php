    ...
    <main>
        <div class="decalage">
			...
			<form id="grapheSelector">
				<h3 class="choixAffichageGraphe">Choisir un type de representation de grpahe : </h3>
				<div class="container" >
					<input class="btnRadioGraphe" type="radio" id="btn_radio1" name="grapheType" value="compagnie" checked><label for="btn_radio1">Par compagnie</label>
				</div>
				<div class="container" >
					<input class="btnRadioGraphe" type="radio" id="btn_radio2" name="grapheType" value="Lieu"><label for="btn_radio2">Par lieu</label>
				</div>
				<div class="container" >
					<input class="btnRadioGraphe" type="radio" id="btn_radio3" name="grapheType" value="representation"><label for="btn_radio3">Par representation</label>
				</div>
			</form>
